	...
	public void onTick(EventTick event) {
		...
		for (int i = 0; i < 9; i++) {
			if (mc.player.inventory.getStack(i).getItem() == Blocks.OBSIDIAN.asItem()
					|| mc.player.inventory.getStack(i).getItem() == Blocks.NETHERITE_BLOCK.asItem()) {
				blockSlot = i;
				break;
			}
		}
		...
		if (mc.player.distanceTo(target) < 5) {
			...
			case 0:
				if (mc.world.getBlockState(targetPos.add(0, 1, 0)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
							target.getPos().add(0, 1, 0), Direction.UP, targetPos.add(0, 1, 0), false));
					mc.player.swingHand(Hand.MAIN_HAND);
				}
				if (mc.world.getBlockState(targetPos.add(1, 0, 0)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
							target.getPos().add(1, 0, 0), Direction.UP, targetPos.add(1, 0, 0), false));
					mc.player.swingHand(Hand.MAIN_HAND);
				}
				if (mc.world.getBlockState(targetPos.add(-1, 0, 0)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
				...
				if (mc.world.getBlockState(targetPos.add(0, 0, 1)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
							target.getPos().add(0, 0, 1), Direction.UP, targetPos.add(0, 0, 1), false));
					mc.player.swingHand(Hand.MAIN_HAND);
				}
				if (mc.world.getBlockState(targetPos.add(0, 0, -1)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
			...
			case 1:
				...
				if (mc.world.getBlockState(targetPos.add(1, -1, 0)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
							target.getPos().add(1, 0, 0), Direction.UP, targetPos.add(1, -1, 0), false));
					mc.player.swingHand(Hand.MAIN_HAND);
				}
				if (mc.world.getBlockState(targetPos.add(-1, -1, 0)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
				...
				if (mc.world.getBlockState(targetPos.add(0, -1, 1)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
							target.getPos().add(0, 0, 1), Direction.UP, targetPos.add(0, -1, 1), false));
					mc.player.swingHand(Hand.MAIN_HAND);
				}
				if (mc.world.getBlockState(targetPos.add(0, -1, -1)).getMaterial().isReplaceable()) {
					mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(
